...
class TRP_Machine_Translation_Tab {
    ...
    */
    ...
    public function load_engines(){
        ...
        include_once TRP_PLUGIN_DIR . 'includes/openrouter/functions.php';
        include_once TRP_PLUGIN_DIR . 'includes/openrouter/class-openrouter-machine-translator.php';

        include_once TRP_PLUGIN_DIR . 'includes/chatgpt/functions.php';
        include_once TRP_PLUGIN_DIR . 'includes/chatgpt/class-chatgpt-machine-translator.php';
    }
    ...
    public function get_active_engine( ){
        ...
        if( empty( $this->settings['trp_machine_translation_settings']['translation-engine'] ) )
            ...
            $existing_engines = apply_filters('trp_automatic_translation_engines_classes', array(
                ...
                'chatgpt'             => 'TRP_ChatGPT_Machine_Translator'
            ));
