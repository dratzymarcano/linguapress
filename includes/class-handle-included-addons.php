...
if ( !class_exists('TRP_Handle_Included_Addons') ){
    class TRP_Handle_Included_Addons{
        ...
        function trp_main_plugin_minimum_version_check(){
            if ( defined('TRANSLATE_PRESS') && TRANSLATE_PRESS === 'TranslatePress - Dev' ) return;
            ...
            if( !empty( $add_ons_settings ) ){
                foreach( $add_ons_settings as $add_on_slug => $add_on_enabled ){
                    if( $add_on_enabled ){
                        ...
                        if( $add_on_slug === 'tp-add-on-seo-pack/tp-seo-pack.php' && file_exists(TRP_PLUGIN_DIR . 'add-ons-advanced/'. $seo_addon_dir .'/tp-seo-pack.php') )
                            require_once TRP_PLUGIN_DIR . 'add-ons-advanced/'. $seo_addon_dir .'/tp-seo-pack.php';
                        if( $add_on_slug === 'tp-add-on-extra-languages/tp-extra-languages.php' && file_exists(TRP_PLUGIN_DIR . 'add-ons-advanced/extra-languages/tp-extra-languages.php') )
                            require_once TRP_PLUGIN_DIR . 'add-ons-advanced/extra-languages/tp-extra-languages.php';

                        //include here the PRO addons
                        if( $add_on_slug === 'tp-add-on-automatic-language-detection/tp-automatic-language-detection.php' && file_exists(TRP_PLUGIN_DIR . 'add-ons-pro/automatic-language-detection/tp-automatic-language-detection.php') )
                            require_once TRP_PLUGIN_DIR . 'add-ons-pro/automatic-language-detection/tp-automatic-language-detection.php';
                        if( $add_on_slug === 'tp-add-on-browse-as-other-roles/tp-browse-as-other-role.php' && file_exists(TRP_PLUGIN_DIR . 'add-ons-pro/browse-as-other-roles/tp-browse-as-other-role.php') )
                            require_once TRP_PLUGIN_DIR . 'add-ons-pro/browse-as-other-roles/tp-browse-as-other-role.php';
                        if( $add_on_slug === 'tp-add-on-deepl/index.php' && file_exists(TRP_PLUGIN_DIR . 'add-ons-pro/deepl/index.php') )
                            require_once TRP_PLUGIN_DIR . 'add-ons-pro/deepl/index.php';
                        if( $add_on_slug === 'tp-add-on-navigation-based-on-language/tp-navigation-based-on-language.php' && file_exists(TRP_PLUGIN_DIR . 'add-ons-pro/navigation-based-on-language/tp-navigation-based-on-language.php') )
                            require_once TRP_PLUGIN_DIR . 'add-ons-pro/navigation-based-on-language/tp-navigation-based-on-language.php';
                        if( $add_on_slug === 'tp-add-on-translator-accounts/index.php' && file_exists(TRP_PLUGIN_DIR . 'add-ons-pro/translator-accounts/index.php') )
                            require_once TRP_PLUGIN_DIR . 'add-ons-pro/translator-accounts/index.php';
                    }
                }
            }
        ...
        function include_mandatory_addon_files(){
            if( file_exists(TRP_PLUGIN_DIR . 'add-ons-pro/translator-accounts/includes/class-translator-accounts-activator.php') )
                require_once TRP_PLUGIN_DIR . 'add-ons-pro/translator-accounts/includes/class-translator-accounts-activator.php';

            if ( file_exists( TRP_PLUGIN_DIR . 'add-ons-advanced/seo-pack/tp-seo-pack-activator.php' ) ) {
                require_once TRP_PLUGIN_DIR . 'add-ons-advanced/seo-pack/tp-seo-pack-activator.php';
            }
        }
    }
}
