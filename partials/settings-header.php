...
<div id="trp-settings-header">
    <div class="trp-settings-logo">
        <h2 style="margin: 0; font-size: 24px; font-weight: 600; color: #1e3a5f;">LinguaPress</h2>
    </div>

    <div id="trp-header-items-wrapper">
        <a class="trp-header-link" href="https://github.com/dratzymarcano/translatepress/issues">
        ...
        <a class="trp-header-link" href="https://github.com/dratzymarcano/translatepress">
