    ...
    public function send_request( $source_language, $language_code, $strings_array ){
        ...
        $response = wp_remote_post( 'https://openrouter.ai/api/v1/chat/completions', array(
            'headers' => array(
                ...
                'HTTP-Referer' => get_site_url(), // Optional, for including your app on openrouter.ai rankings.
                'X-Title' => get_bloginfo('name'), // Optional. Shows in rankings on openrouter.ai.
            ),
